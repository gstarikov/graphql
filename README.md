...
godoc: https://godoc.org/github.com/gstarikov/graphql

### Getting Started

To install the library, run:
```bash
go get github.com/gstarikov/graphql
```
...
```
For more complex examples, refer to the [examples/](https://github.com/gstarikov/graphql/tree/master/examples/) directory and [graphql_test.go](https://github.com/gstarikov/graphql/blob/master/graphql_test.go).

### Third Party Libraries
| Name          | Author        | Description  |
|:-------------:|:-------------:|:------------:|
| [graphql-go-handler](https://github.com/gstarikov/graphql-go-handler) | [Hafiz Ismail](https://github.com/sogko) | Middleware to handle GraphQL queries through HTTP requests. |
| [graphql-relay-go](https://github.com/gstarikov/graphql-relay-go) | [Hafiz Ismail](https://github.com/sogko) | Lib to construct a graphql-go server supporting react-relay. |
